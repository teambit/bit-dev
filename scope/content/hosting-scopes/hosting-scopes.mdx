...
This page goes through the steps of hosting scopes on remote servers, using [Docker](https://www.docker.com/).

## Installing Bit

To install [BVM](/reference/using-bvm) and use BVM to install Bit:
...
For the Docker Image, [see here](https://hub.docker.com/r/bitcli/bit).

## Initialize a Scope and Run Server

To initialize a scope and run the server:
...
For the Docker Image, [see here](https://hub.docker.com/r/bitcli/bit-server).
