...
Scope is a **collaboration server for components**. Scopes help teams to share and use each other's components - preserving team autonomy through versioning, forking, storing dependencies - and collaborate on changes of independent components.
...
Scopes host components of any kind, from React, Angular and Node modules, all the way to frontend apps or microservices. For a scope, they are all Bit Components.  
...
<!-- TODO, create docs for Aspect and link at [Bit Aspect] -->
