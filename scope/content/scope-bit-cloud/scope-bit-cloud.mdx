...
A component can also have its scope defined when it is created, by using the `--scope` option. To learn more, see [Creating components](https://bit.dev/docs/getting-started/composing/creating-components).
