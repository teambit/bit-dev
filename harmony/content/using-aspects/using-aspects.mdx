...
<ComponentCardDisplay componentIds={['teambit.typescript/typescript', 'teambit.angular/angular', 'teambit.mdx/mdx']} />
...
Aspects can be configured across any [Bit config](/config/bit-config). That means, you can use aspects to extend the functionality of Scopes, Workspaces,
...
Aspects can be used as dependencies by other aspects. See [Using dependencies](/extending-bit/create-aspect#using-dependencies).
