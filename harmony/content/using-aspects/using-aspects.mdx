...
You can use official and community Aspects built by us and the Bit community like the ones below or [build your own Aspect](/docs/extending-bit/creating-aspects).
...
You can find more [available aspects to use here](/plugins) and on the [bit.cloud](https://bit.cloud/components?env=aspect) search!

## Using Aspects

Aspects can be configured across any [Bit config](/). That means, you can use aspects to extend the functionallity of Scopes, Workspaces,
...
Aspects can be used as dependencies by other aspects. See [Using dependencies](/docs/extending-bit/creating-aspects#using-dependencies).
