...
A lane is similar to a component as it's it also managed within a scope. This means that when we create a new lane, we essentially add a new item to our [local scope](/workspace/local-scope). The lane will later get exported, just like any other component, to a remote scope.
