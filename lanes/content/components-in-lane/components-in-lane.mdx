...
Lanes hold [snaps](components/snaps) of components. A single lane can hold multiple snaps of various components. This way you aggregate changes for many components under a single roof.
