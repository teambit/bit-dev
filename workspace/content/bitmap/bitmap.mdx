...
`.bitmap` is a file auto-generated and managed by Bit in the [Workspace](/workspace/overview) for mapping each component to its corresponding directory in the project's file system.
