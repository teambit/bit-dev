...
'Variants' enables you to configure groups of components with [Component configuration](/components/component-config).
...
you can prevent this propagation for specific set of inheritors, by setting set the `propagate` value of an inheriting group of components to `false`.
