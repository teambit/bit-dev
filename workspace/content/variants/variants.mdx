...
Variants enables you to configure group of components with [Component configuration](/components/component-config). Components are selected using their common directory path or namespace, and then set with an Aspect and its corresponding configuration.
