...
Workspaces are usually source-controlled as "standard projects" using SCMs like git. However, once a Component in a Workspace is versioned and exported to a Remote Scope, it is no longer coupled to it in any way.
