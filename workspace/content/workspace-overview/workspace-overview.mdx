...
You can use the Bit workspace to either create, use or import components, make changes to them, and export these changes back. 
...
existing repositories or shared as a Workspace component.
