...
A Bit Workspace is where you build Components and compose them into systems.

Components authored and maintained in a Workspace are not coupled to it in any way. They can be exported out and imported into other Workspaces.
...
Components in your workspace are displayed in the Workspace UI, served by Bit's dev server. To start it, run the following command:
