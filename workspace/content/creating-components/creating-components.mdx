...
By default, the newly created component will appear in the Workspace in the same directory as the name of its Scope. You can modify the name of the Scope in the Workspace [`.bitmap`](/workspace/bitmap) file. In our case, the scope was called `my-scope`, so the button Component was generated at my-scope/button.
