...
Every component directory must include a [Main File](/components/component-main-file) (an entry file). The directory can be located anywhere in the Workspace (directory), excluding only the [node_modules](/dependencies/node-modules) directory and other Component Directories.
