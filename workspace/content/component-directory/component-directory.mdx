...
A Component Directory is a directory for a Component in the [Workspace](/workspace/overview). The mapping of Components to their directories can be found in the [.bitmap](/workspace/bitmap) file (see the `rootDir` property).
...
To learn more on tracking components in the Workspace. Head over to the [Tracking Components section](/docs/workspace/tracking-components).
