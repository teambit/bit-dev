...
When you export components to a Remote Scopes you make them available for other developers to consume and to collaborate on.
You can create Remote Scopes on your own server or, you can manage your scopes on [bit.cloud](https://bit.cloud).
