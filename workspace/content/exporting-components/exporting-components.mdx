...
Once you have created staged [snaps](/docs/components/snaps) or [versions](/docs/components/tags), you can run the `status` command to validate that can safely export new versions.
