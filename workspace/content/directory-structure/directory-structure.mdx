...
The Bit [Workspace](/workspace/overview) is flexible in directory structure, preserving a seamless dev experience for building with components. It is flexible enough for teams to decide how they prefer to structure their [Workspace](/workspace/overview).
