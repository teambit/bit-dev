...
The Bit [Workspace](/workspace/workspace-overview) is flexible in directory structure, preserving a seamless dev experience for building with components. It is flexible enough for teams to decide how they prefer to structure their [Workspace](/workspace/workspace-overview).

There is no hard limit on how deep you can nest components, nor anything blocking you from having some parts of your workspace structure flat, and others nested. How you want to sort your components is up to you.
