...
<ComponentCardDisplay
  componentIds={['teambit.harmony/application']}
...
An application can be of different types. The most basic type is Node, but different components add new [Application Types](/apps/application-types) you can
