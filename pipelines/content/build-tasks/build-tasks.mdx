...
Build tasks are operations that are during the component build pipeline. A build task can either be built as part of an env or an aspect, or as a standalone component.  
When used as a standalone component (such as this guide), you may manage and version the build task just like any other component. You can even use it in various aspects.
