...
Builder runs the build-pipeline for each component in an isolated component environment called [Capsule](/builder/capsule) to validate a component is completely independent from the workspace.
