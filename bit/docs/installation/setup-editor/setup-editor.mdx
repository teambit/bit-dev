...
[VSCode](https://code.visualstudio.com/) is one of the most popular and free editors in use today.
...
You can use standard editors and tools to edit code and text on the Bit workspace.
