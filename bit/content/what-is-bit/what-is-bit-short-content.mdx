...
Bit is an open-source software for distributed component development.
...
Bit comes with native support for various dev tools like [TypeScript](/tools/typescript), [Babel](/tools/babel), [Jest](/tools/jest), [Webpack](/tools/webpack), [ESLint](/tools/eslint) and
