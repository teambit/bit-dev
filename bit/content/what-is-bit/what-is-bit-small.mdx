...
small components, with different responsibilities. An App is the most "concrete" component with a large depenendecy graph, and button is the most "abstract" component with just few dependencies and a lot of dependents, indecating higher reusability. They have different size but they are equal in size and importance.