...
<!-- People tend to think of components like apps as "bigger" and components like a button as "smaller", but for us they are the same size.  -->

<!-- Both Button and App are 
components, with different responsibilities. An App is the most "concrete" component with a dependecy graph and minor amount of dependents, and button is the most "abstract" 
