...
A scope is a collaboration server for components. Scopes define ownership on components, as a single team owns the components exported to a scope.
...
[Learn more about scopes](/scope/scope-overview)
