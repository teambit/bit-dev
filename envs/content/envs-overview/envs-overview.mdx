...
Envs are implemented as [Bit Components](/components/component-overview) that compose together different workflows ([env services](/envs/env-service-overview)) and configs for testing, linting, formatting, previewing and others.  
...
Checkout all available services [here](/dev-services-overview/available-services). And if you need to create your own, follow this [guide](/envs/creating-your-own-services).
