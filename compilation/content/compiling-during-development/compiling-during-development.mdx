...
:::note
For type resolution in the Workspace we rely on the [Workspace Component Link](/workspace/structure/component-link) which symlinks the source code from within the link to the corresponding [Component Directory](/workspace/structure/component-link).
:::
