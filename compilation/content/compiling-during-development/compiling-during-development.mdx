...
:::note
For type resolution in the Workspace we rely on the [Workspace Component Link](/workspace/component-link) which symlinks the source code from within the link to the corresponding [Component Directory](/workspace/component-link).
:::
