...
:::note
For type resolution in the Workspace we rely on the [Workspace Component Link](/workspace/component-links) which symlinks the source code from within the link to the corresponding [Component Directory](/workspace/component-links).
:::
...
- [bit start](/reference/cli-reference/cli-reference#start)s
