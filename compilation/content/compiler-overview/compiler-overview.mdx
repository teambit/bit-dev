...
The Compiler aspect provides a single interface for Component compilation, [during development](/compiler/compiling-during-development) and [during build](/compiler/compiling-during-build).
