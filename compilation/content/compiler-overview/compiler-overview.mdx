...
The Compiler Aspect standardizes compilation during development in the development Workspace by providing the `bit compile` command, to compile all components, regardless of the specific compiler set by their corresponding Envs.
