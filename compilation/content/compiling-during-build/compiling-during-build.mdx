...
Compilation of components in the [Workspace](/workspace/workspace-overview) is optimized for dev experience, performance and debugging by default.
...
For type resolution in the Workspace we rely on the [Workspace Component Link](/workspace/component-links) which symlinks the source code from within the link to the corresponding [Component Directory](/workspace/component-directory).
...
- [bit compile](/reference/cli-reference/cli-reference#compile)
- [bit watch](/reference/cli-reference/cli-reference#watch)
- [bit start](/reference/cli-reference/cli-reference#start)
