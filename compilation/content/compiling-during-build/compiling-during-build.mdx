...
For type resolution in the Workspace we rely on the [Workspace Component Links](/workspace/structure/component-links) which symlinks the source code from within the link to the corresponding [Component Directory](/workspace/structure/component-directory).
