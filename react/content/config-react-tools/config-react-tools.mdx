...
See ['Inspecting an Env's Configurations'](/docs/envs/inspecting-env) to learn how to validate your Env is configured as expected.
...
[See here](https://bit.dev/teambit/typescript/modules/ts-config-mutator/~code/ts-config-mutator.ts) to learn more about the TypeScript's config mutator API

[See here](https://github.com/teambit/examples/blob/master/react/examples/extensions/my-react/my-react.main.runtime.ts) for a full example.
...
[See here](https://bit.dev/teambit/defender/eslint/config-mutator/~code/config-mutator.ts) to learn more about ESLint's config mutator API.
...
[See here](https://bit.dev/teambit/defender/prettier/config-mutator/~code/config-mutator.ts) to learn more about the Prettier's config mutator API.
...
[Go to 'Configuring Webpack'](/docs/tools/webpack/configure-webpack).
...
[See here](https://github.com/teambit/examples/blob/master/react/examples/extensions/my-react/my-react.main.runtime.ts) for a full example.
[See here](https://github.com/teambit/examples/blob/master/react/examples/extensions/my-react/my-react.main.runtime.ts) to learn how to customize the tag and snap pipelines.
