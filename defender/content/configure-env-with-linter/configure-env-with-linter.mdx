# Configure an Env with a Linter

The `getLinter` method sets the Env to use a Linter implementation (for example, the [ESLint Aspect](https://bit.cloud/teambit/defender/eslint)).
