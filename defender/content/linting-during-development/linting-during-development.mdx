...
Bit lints all components in the [Workspace](/workspace/workspace-overview) regardless to the configured [Env](/envs/overview) and therefor tester, with a single command.
