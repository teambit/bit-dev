...
These Aspects implement the [Tester interface](https://bit.dev/teambit/defender/tester/~code/tester.ts). A tester implementation should be able to provide [testing in the workspace](/workspace-testing) as well as [testing during build](./dev-services-overview/tester/testing-during-build).
