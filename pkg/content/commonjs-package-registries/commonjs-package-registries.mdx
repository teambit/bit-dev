...
You can use the `{name}` and `{scope}` placeholders to inject each component's [full name](/components/component-id#component-full-name), and [scope name](/components/component-id#component-full-name), to the corresponding package name.
