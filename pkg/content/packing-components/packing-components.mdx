...
Component packages are generated during execution of the Component [build pipeline](build-tasks) and persisted as [Artifacts](/dev-services/builder/build-artifacts) 
