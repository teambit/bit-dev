...
in differnet variations for testing, visulization and discoverability purposes. 
...
Compositions are compitible with the Storybook`s [Story format](https://storybook.js.org/docs/react/api/csf).
