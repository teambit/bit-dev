# Mounting compositions to the DOM
...
Learn more about it, [here](/dev-services-overview/preview/overview)
:::

## Setting a mounter

To set your own template, create a new Env (or extend and existing one), and implement the `getMounter()` [service handler](/envs/dev-services).
...
// Example: Wrapping the composition with context-providers
