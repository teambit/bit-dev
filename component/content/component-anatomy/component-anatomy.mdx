...
Component dependencies are managed by the [dependency resolver](/dependencies/dependencies-overview). This tool reads through all `import` and `require` statement in the component source code, and maps them to components or installed packages.
