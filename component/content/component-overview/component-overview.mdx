...
Each component has a unique [ID](/components/component-id) and contains [Source Code](/components/source-code), [Dependencies](/dependencies/overview), [Artifacts](/components/artifact), [Configuration](/components/component-config) and [Metadata](/components/metadata). Component generate and manage its own artifacts, like [Package](/packages/package), [Distribution](/compiler/dist), and even a [Preview](/preview/preview).  
Components are connected together through dependencies, as Bit forms a complete dependency graph of your codebase.
