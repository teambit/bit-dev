...
Each is an [independently source-controlled](/components/component-objects) module that is stored in [Scopes](/scope/scope-overview) and maintained in [Workspaces](/workspace/workspace-overview).
