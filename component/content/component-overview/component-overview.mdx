...
Now that it is recognized as a Component by Bit, it uses different Bit Aspects for its development.
These Aspects and their corresponding configurations are applied on this Component by various sources in the Workspace.
These Aspect configurations are also part of this Component.
...
$ bit show card
```
The output contains information regarding its Component ID, source files, main file, and dependencies (where some are components and some are packages).
