...
Components directly refer to all their available semantic versions. Version history and precedence is determined by semantic verion, not when a tag was created.
