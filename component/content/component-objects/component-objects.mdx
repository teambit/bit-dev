...
Component objects are stored in the [Local Scop](/docs/workspace/local-scope), using the [content-addressable storage](https://en.wikipedia.org/wiki/Content-addressable_storage) method.
