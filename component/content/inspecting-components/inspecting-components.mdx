...
my-new-ws/pages/welcome@0.0.1
  teambit.compilation/compiler
    TSCompiler
      ...
      dist/index.js
      dist/index.js.map
      dist/wecome.spec.d.ts
      dist/wecome.spec.js
      dist/wecome.spec.js.map
...
The 'History' tab <img src={logIconImg} width="15rem"></img> shows a component's version history. The different versions can be explored further by clicking on their links.
