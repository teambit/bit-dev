...
Configuration is a core part of each [component's anatomy](/component/component-anatomy), making it a part of each component version.
...
While configuration is a per-component "thing", Bit offers a set of features to control many components by using configuration rules called [Variants](/variants/overview) as part of the [workspace configuration](/workspace/workspace-configuration).
