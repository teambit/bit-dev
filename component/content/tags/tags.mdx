...
Note that the new version of an auto-tagged component always get a patch bump, regardless of the version number increment of the component being explicitly tagged.
