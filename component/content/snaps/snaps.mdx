...
The snap command runs the component's [build and snap pipelines](./dev-services-overview/builder/build-pipelines) before it creates a new version (that includes the build's generated data and artifacts).
