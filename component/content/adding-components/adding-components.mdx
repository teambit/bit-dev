...
[Learn more on naming components](docs/components/component-id).

## Main File

Main file is the entry point for the component. You can specify the main file using the --main flag on the bit add command. If the main file was not specified, Bit is trying to determine the main file as follow:
