...
The component structure is aggregated to a single view. Read more on [component structure](docs/components/component-structure).
...
[Learn more on component ID](docs/components/component-id).

## Main File

Main file exposes the API of the component. It's recommended to have an `index` file as the **main file**. You can specify the main file using the `--main` flag on the bit add command.  [Read more about main files](/docs/components/component-main-file).
...
<img src={isolateDeps} style={{ maxHeight:'200px' }} />
