...
Even though dependencies are usually set automatically by using [Dependency Policies](/dependencies/dependency-policies), components in the Workspace can be configured with a
specific set of dependencies. Component dependencies can either be configured with [Variants](/workspace/variants), by the development environment, by ejecting the component configuration, or by editing the [component.json](/components/structure/component-json)
