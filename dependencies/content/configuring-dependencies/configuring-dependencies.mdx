...
specific set of dependencies. Component dependencies can either be configured with [Variants](/workspace/variants), by the development environment, by ejecting the component configuration, or by editing the [component.json](/components/component-json)
