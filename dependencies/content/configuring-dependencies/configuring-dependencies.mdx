...
Even though dependencies are usally set automatically by using [Dependency Policies](/dependencies/dependency-policies), components in the Workspace can be configured with a 
