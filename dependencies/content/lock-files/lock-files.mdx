...
When running the `bit install` command, a lock file is generated in the workspace root directory. The type of lock file generatd is determined by the package manager (used via the Dependency Resolver).
