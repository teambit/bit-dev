...
Bit's [Package Manager Aspect](/packages/packages-overview) encapsulates [Yarn](/aspects/yarn), [pnpm](/aspects/pnpm), [NPM](/aspects/npm) or any other [supported CommonJS package manager](package-manager/) using the `bit install` command.
