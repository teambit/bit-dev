...
It fetches [component objects](/docs/components/component-objects) and uses modern package package managers such as [pnpm](https://pnpm.io/) and [Yarn](https://yarnpkg.com/) to make sure each independent component is resolved with the correct dependencies and their corresponding versions.
...
Dependencies can also be added with a specific version. [SemVer](https://semver.org/) ranges can also be set on the Workspace [Dependency Policy](/docs/dependencies/dependency-policy).
