...
- Simple examples should start by demonstrating a standard use-case, statically. The code snippet for this should include import statements.
- Follow the above with live examples showcasing other forms of usages. Live examples should not include import statements.
- Complicated components should be explained via templates and demo components instead of verbose instructions and long snippets of code
...
An introduction section always include an explanation of what, why and how.
