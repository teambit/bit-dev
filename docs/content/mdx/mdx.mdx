...
Use Bit's `description` and `labels` front matter properties to customize the docs ['abstract'](/dev-services-overview/docs/docs-overview#abstract) and ['labels'](/dev-services-overview/docs/docs-overview#labels).
...
The MDX file content is compiled by Bit and exported as the default. There's no need to wrap the [content section](/dev-services-overview/docs/docs-overview#content) in a class or a function.
