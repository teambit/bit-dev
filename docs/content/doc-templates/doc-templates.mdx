...
To set your own template, create a new Env (or extend and existing one), and implement the `getDocsTemplate()` [service handler](/envs/dev-services#service-handlers).
...
3. `DocsFile` - data extracted from the component's docs file (see next section to learn more).
...
- `default?: any` - the docs file ['content'](/dev-services/docs/docs-overview#content) section.
- `examples: Example[]` - the docs file ['live examples'](/dev-services/docs/docs-overview#live-examples).
- `labels: string[]` - the docs file ['labels'](/dev-services/docs/docs-overview#labels).
- `abstract: string` - the docs file ['abstract'](/dev-services/docs/docs-overview#abstract) (component description).
