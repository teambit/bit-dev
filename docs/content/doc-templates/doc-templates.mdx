...
- `default?: any` - the docs file ['content'](/dev-services-overview/docs/docs-overview#content) section.
- [`examples: Example[]`](/overview#live-examples) - the docs file ['live examples'](/dev-services-overview/docs/docs-overview#live-examples).
- `labels: string[]` - the docs file ['labels'](/dev-services-overview/docs/docs-overview#labels).
- `abstract: string` - the docs file ['abstract'](/dev-services-overview/docs/docs-overview#abstract) (component description).
