...
- Define the top component.
- Understand how and where the component would be used. The more the merrier!
...
Start by taking the product spec, together with a designer and a product manager and define the components that play role. Easiest is to start with the UI
