...
As you might have noticed, this site was built in independent components. As we built the new documentation we started hiring more people to work at Bit and we needed
a wiki to be a single source of truth for all information internal at Bit to keep everyone in sync as we scale and decided to document the process to demonstarate
thinking in components. 
...
Search for these components, try to **use or collaborte on something that exists**, otherwise **create a new component that fulfills this exact need**.
...
The first step is thinking which components you wish you had now: 

Looking into the design sketch, In our case I needed the follwing
...
Components are the small and reusable portions of value you can find and capitalize in the work you do. You should think of a component as an independent, reusable 
product with an interface for using it. A component serve a single purpose. You design the component interface for your own needs, then expand over time to support the needs of other teammates, 
other product teams and eventually to entire world.

Components can be anything starting from pieces of content, UI components, pages, sections, backend services, 
frontend apps to simple software modules and anything else you can put to imgination. Here are few examples of components used in this website:
...
## The mispreception of short term


## Implmeneting the component
