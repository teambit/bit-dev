...
<Subtitle>
  Components can change the way you think about almost everything. Thinking in components is balancing short term and long term value creation,
  in a way that helps do better work on the short term that translate to exponentially growing creation of value over time. 
</Subtitle>
...
a greater whole. 
This could apply on almost anything we create digitally, from software development, to content creation, design, product management and anything else digital you might imagine.
