...
## Components
Components is the core concept of component-driven software. They are the bulding block of every component-based architecture. From service-orientation, like Microservices, and 
