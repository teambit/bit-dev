...
Now that you've created a remote scope on bit.cloud, validate the `defaultScope` property in the `workspace.jsonc` config file, is set to the correct username/org and scope name.
