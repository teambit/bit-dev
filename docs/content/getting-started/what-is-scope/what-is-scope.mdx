...
Remote scopes are hosted on [Bit.dev](/docs/getting-started/collaborate/remote-scope/host-on-bit-cloud) or [self-hosted Bit servers](/docs/getting-started/collaborate/remote-scope/self-host-scope).
