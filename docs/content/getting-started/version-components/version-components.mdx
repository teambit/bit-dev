...
A component in Bit has its own history. This history contains code, dependencies and configuration changes, together they form the [Component Snap](docs/components/snaps). Snaps are shared using a remove Bit scope.
...
Read more about [snaps](/docs/components/snaps) or [tags](/docs/components/tags) and how to use them.
