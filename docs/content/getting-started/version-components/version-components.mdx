...
When creating a snapshot, Bit performs the actions below:
...
- Setting a snapshot of the component.

At the end of the process, Bit creates an immutable snapshot of the component, containing:
