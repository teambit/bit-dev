...
When using [bit.cloud](https://bit.cloud) for hosting components, consumers will need to configure their package manager to know where to fetch components from. Do this by configuring [`.npmrc`](https://docs.npmjs.com/cli/v7/configuring-npm/npmrc) file:

1. First of all - [install Bit](/getting-started/installing-bit/installing-bit) on your system.
