...
To learn more about the Formatter, please head over to the [Formatter documentation](/dev-services-overview/formatter/formatter-overview) section.

### `build`

[Builder](/dev-services-overview/builder/builder-overview) service composes the [build pipeline](/dev-services-overview/builder/build-pipelines) from tasks implemented by other [services](/envs/dev-services) such as [Compiler](/dev-services-overview/compiler/compiler-overview) or [Tester](/dev-services-overview/tester/tester-overview).
...
To learn about building components and the Builder, head over to the [Builder documentation](/dev-services-overview/builder/builder-overview) section.
