...
For example: [Compilation](/dev-services/compiler/compiler-overview), [Testing](/dev-services/tester/tester-overview), [Build Pipeline](/dev-services/builder/builder-overview), [Linting](/dev-services/linter/linter-overview) and more. Services use various tools like TypeScript <!-- [TypeScript](/typescript/overview) --> or Jest <!-- [Jest](/jest/overview) -->. Composed together with configurations, services form an entire development experience for React, Node or Angular.  
...
[Environment Services](/envs/envs-overview) define what tools would run and their configs. These services correspond to the different Bit commands you can use while building with Bit.
...
To learn more on Compiler, head to over to the [Compiler documentation](/dev-services/compiler/compiler-overview).
...
The [tester](/dev-services/tester/tester-overview) service knows to run tests and extract their results to a standardized format to be presented in the UI.
...
To learn more about the Tester and component Testing, head over to the [Tester documentation](/dev-services/tester/tester-overview).
...
To learn more about linting components and the Linter, head over to the [Linter documentation](/dev-services/linter/linter-overview) section.
...
To learn more about the Formatter, please head over to the [Formatter documentation](/dev-services/formatter/formatter-overview) section.

### `build`

[Builder](/dev-services/builder/builder-overview) service composes the [build pipeline](/dev-services/builder/build-pipelines) from tasks implemented by other [services](/envs/services/overview) such as [Compiler](/dev-services/compiler/compiler-overview) or [Tester](/dev-services/tester/tester-overview).
...
To learn about building components and the Builder, head over to the [Builder documentation](/dev-services/builder/builder-overview) section.
