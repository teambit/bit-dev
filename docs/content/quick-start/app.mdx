...
interface. Undestanding the need and identifying the 
...
For this demo, we will use the following component.
...
Use a differnet routing solution. Or implement a provider. 
NextJS link.
