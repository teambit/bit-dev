...
The workspace was designed for gradual adoption and has a minimal footprint. Since components are isolated, it can easily co-exist next to other development tools, 
...
## Create components
Components can be anything as simple as a module or as large as an entire app. Different types of components might require different 
They might have different characteristics applied on them based on the Env they are
configured with. That helps to differentiate different types of components that require different build. 

- What is a component? What can a component be?
- Naming
- Which component to start with? and why?
