...
and reusable pieces called ["components"](/components) that fit well together**. Components can be anything, independent by nature from a plain Node module, React component,
 React hook, Microservice, Angular module, serverless function and to anything else you might imagine. Using Bit could also remind you of composing a
