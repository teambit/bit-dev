...
### What is Bit?
Bit is a toolchain for component-driven software. It helps you take a complex product requirement, and break them down into independent pieces called ["components"](/components). 
A component can be anything from a React component, Node modules, React hooks, micro-services, Angular module or any other independent and composable unit of code you can think of. 
Every component you build is compounding to an ever growing "memory" of independent components. 
If you are a developer, this might remind you of a package

Using Bit could also remind you of building a Catsle out of Lego bricks. That can be a lot of fun!
