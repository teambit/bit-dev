...
# Quick start
<!-- 
<Subtitle>Welcome to the Bit documantation site! This site is composable.</Subtitle> -->

Welcome to the Bit documantation site! This site is a composition of independent components, built and maintained by the [Docs](https://bit.dev/teambit/docs), 
...
During this quick start, you will create your own **personal component-driven app**. We will show you how simple it is, to build even a complex app like a wiki when built from components!
...
create your own component-driven personal app from and learn how to use components to build to poissibly anything. -->
...
<!-- TODO: Kutner add dark theme -->

<ExcludeHighlighter>
  <BubbleHighlighter componentId={ComponentID.fromString('teambit.wiki/apps/wiki')} showId>
    {/* @HACK, cannot nest MemoryRouter inside another router - see https://github.com/remix-run/react-router/issues/7375 */}
...
<!-- TODO: think of a way to direct non-technical people to thinking in components earliar on -->
...
component, **think which components you wish you had now**. Search for these components, try to **use or collaborte on something that exists**, 
...
The usage occurences there is for a component, the better.

Building in components is a recursive process.

<WikiGraph />

<ComponentThinkingProcess steps={[
  {
