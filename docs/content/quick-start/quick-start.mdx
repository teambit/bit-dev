...
import { MultiHighlighter, ComponentHighligther, ExcludeHighlighter } from '@teambit/react.ui.component-highlighter';
...
<LeftRight 
  ...
  left={<MultiHighlighter bgColorHover="#C9C3F6" bgColor="#ECEAFF" watchMotion={true} highlighterOptions={{style:{ fontSize: 8 }}}><TopInnovators /></MultiHighlighter>} 
  right={<InnovatorGraph nodes={demoGraph} />} 
/>
