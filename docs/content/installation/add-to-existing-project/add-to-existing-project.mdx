...
You can intialize Bit on any exsiting workspace to start sharing components. Bit has a minimal footprint on your project and can run alongside existing tools.  
...
- [`workspace.json`](/workspace/workspace-config) file, with base configuration.
