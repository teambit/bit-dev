...
const ComponentArtifacts = lazy(() => import('@teambit/component.docs.component-artifacts'));
const ForkingComponents = lazy(() => import('@teambit/component.docs.forking-components'));
...
const CliReference = lazy(() => import('@teambit/harmony.content.cli-reference'));
const Migration = lazy(() => import('@teambit/docs.content.guides.migration'));
...
export const learnDocsRoutes: DocsRoute[] = [
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'component-artifacts',
            title: 'Component artifacts',
            description:
              "Artifacts are files that are generated by a component's build tasks and stored in its snapshot when it is snapped or tagged.",
            component: <ComponentArtifacts />,
          },
          {
      ...
      },
      {
        ...
        description:
          'Importing is the process of fetching components from their remote scope, to use and maintain them in the workspace.',
        component: <ImportingComponents />,
      },
      {
        path: 'forking-components',
        title: 'Forking components',
        description: 'When you fork a component from a remote scope, you create a copy of it in your workspace.',
        component: <ForkingComponents />,
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'migrating-from-a-previous-version',
        title: 'Migrating from a previous version of Bit',
        description:
